...
class ExpenseTrackerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Billy Tracker & Budget Planner")
    ...
    def create_widgets(self):
        ...
        self.date_entry.grid(row=0, column=1, padx=12, pady=2)
        ...
        self.budget_label = ttk.Label(display_frame, text=f"Monthly Budget: Ksh{self.monthly_budget:.2f}")
        self.budget_label.grid(row=1, column=0, sticky=tk.W, pady=2)

        self.total_expenses_label = ttk.Label(display_frame, text="Total Expenses: Ksh0.00")
        self.total_expenses_label.grid(row=2, column=0, sticky=tk.W, pady=2)

        self.remaining_budget_label = ttk.Label(display_frame, text=f"Remaining Budget: Ksh{self.monthly_budget:.2f}")
    ...
    def update_budget_info(self):
        ...
        self.total_expenses_label.config(text=f"Total Expenses: Ksh{total_expenses:.2f}")
        self.remaining_budget_label.config(text=f"Remaining Budget: Ksh{remaining_budget:.2f}")
